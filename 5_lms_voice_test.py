...
# --------------------------------------------------
# 음성 파일(STT) → 질문 인식 → 답변 생성
# --------------------------------------------------
def transcribe_audio(file_path: str) -> str:
    """mp3 등 음성 파일을 받아 텍스트로 변환한다."""
    with open(file_path, "rb") as f:

        #=================================================
        # whisper-1  모델로 audio ->  text 변환
        # [참고] https://developers.openai.com/api/docs/models/whisper-1
        # 
        # [ pass를 지우고 여기에 작성하세요 ]
...
if __name__ == "__main__":
    ...
    for audio_path in sorted(glob.glob("./data/*.mp3")):
